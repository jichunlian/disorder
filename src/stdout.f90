...
subroutine stdout_5(time)
  ...
  write(*,'(A)') ' +-----------------------------------------------------------+'
  write(*,'(A)') ' |                     * How to Cite ? *                     |'
  write(*,'(A)') ' | Please Cite The Following Articles When You Use Disorder: |'
  write(*,'(A)') ' | [1] Ji-Chun Lian, Hong-Yu Wu, Wei-Qing Huang, Wangyu Hu,  |'
  write(*,'(A)') ' |     and Gui-Fang Huang, Phys. Rev. B 102, 134209 (2020).  |'
  write(*,'(A)') ' | [2] J.-C. Lian, Yuan Si, Tao Huang,  W.-Q. Huang, W. Hu,  |'
  write(*,'(A)') ' |     and Gui-Fang Huang, Phys. Rev. B 105, 014201 (2022).  |'
  write(*,'(A)') ' +-----------------------------------------------------------+'
  write(*,*)
  return
